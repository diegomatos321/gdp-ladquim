...
export default class EstatuaMadeira extends Phaser.GameObjects.Container {
  constructor(scene, x, y) {
    ...
    this.textura = this.scene.add.image(0, 0, "estatua-madeira");
    ...
    this.setData("tipo-estatua", ESTATUA_CONSTANTS.MADEIRA)
    this.setInteractive({
