...
export default class EstatuaMarmore extends Phaser.GameObjects.Container {
  constructor(scene, x, y) {
    ...
    this.textura = this.scene.add.image(0, 0, "estatua-marmore");
    ...
    this.setData("tipo-estatua", ESTATUA_CONSTANTS.MARMORE)
    this.setInteractive({
  ...
  cleanEvents = (sys) => {
    console.log("Cleaning events from EstatuaMarmore")
